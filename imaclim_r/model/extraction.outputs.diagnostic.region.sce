...
varname = 'Employment|Industry|Energy'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum( labor_ILO(k,energyIndexes))/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "million";
end;

// variable added after the 'navigate' template
varname = 'Sales|Market Share|LDV|Electricity';
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = MSH_cars(k,indice_CAR_BEV)*100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Sales|Market Share|LDV|Liquids'; 
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = MSH_cars(k,indice_CAR_ICE)*100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Sales|Market Share|LDV|Hydrogen'; 
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = MSH_cars(k,indice_CAR_HYD)*100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Capacity|Utilization rate';
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum( VA(k,:) .* charge(k,:)) ./ sum(VA(k,:)) *100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Capacity|Utilization rate|Coal';
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = charge(k,indice_coal) *100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Capacity|Utilization rate|Oil';
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = charge(k,indice_oil) *100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Capacity|Utilization rate|Gas';
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = charge(k,indice_gas) *100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Capacity|Utilization rate|Industry';
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Cap(k,indice_industries) .* charge(k,indice_industries)) ./ sum(Cap(k,indice_industries)) *100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Capacity|Utilization rate|Services';
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = charge(k,indice_composite) *100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;
...
varname = 'Production|Fossil fuels|Coal'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Q(k,indice_coal));
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;

varname = 'Production|Fossil fuels|Gas'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Q(k,indice_gas));
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;

varname = 'Production|Fossil fuels|Oil'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Q(k,indice_oil));
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;
...
varname = 'Production|Market Share|Total'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Q(k,:)) / sum(Q(:,:)) *100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Production|Market Share|Agriculture'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,indice_agriculture) / sum(Q(:,indice_agriculture)) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Production|Market Share|Fossil fuels'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Q(k,indice_coal:indice_Et)) / sum(Q(:,indice_coal:indice_Et)) * 100 ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Production|Market Share|Fossil fuels|Coal'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Q(k,indice_coal)) / sum(Q(:,indice_coal)) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Production|Market Share|Fossil fuels|Gas'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Q(k,indice_gas)) / sum(Q(:,indice_gas)) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Production|Market Share|Fossil fuels|Oil'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Q(k,indice_oil))  / sum(Q(:,indice_gas)) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Production|Market Share|Electricity'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,indice_elec) / sum(Q(:,indice_elec)) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Production|Market Share|Industries'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Q(k,indice_industries)) / sum(Q(:,indice_industries)) * 100 ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Production|Market Share|Construction'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,indice_construction) / sum(Q(:,indice_construction)) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Production|Market Share|Services'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Q(k,[transportIndexes indice_composite])) / sum(Q(:,[transportIndexes indice_composite])) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;
...
varname = 'Export|Total'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,:));
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;

varname = 'Export|Agriculture'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Exp(k,indice_agriculture);
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;

varname = 'Export|Fossil fuels'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,indice_coal:indice_Et));
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;

varname = 'Export|Fossil fuels|Coal'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,indice_coal));
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;

varname = 'Export|Fossil fuels|Gas'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,indice_gas));
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;

varname = 'Export|Fossil fuels|Oil'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,indice_oil));
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;

varname = 'Export|Electricity'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Exp(k,indice_elec);
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;

varname = 'Export|Industries'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,indice_industries));
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;


varname = 'Export|Construction'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Exp(k,indice_construction);
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;

varname = 'Export|Services'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,[transportIndexes indice_composite]));
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe or pseudo-quantities";
end;

// Export market share
varname = 'Export|Market Share|Total'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,:)) / sum(Exp(:,:)) *100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Export|Market Share|Agriculture'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Exp(k,indice_agriculture) / sum(Exp(:,indice_agriculture)) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Export|Market Share|Fossil fuels'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,indice_coal:indice_Et)) / sum(Exp(:,indice_coal:indice_Et)) * 100 ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Export|Market Share|Fossil fuels|Coal'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,indice_coal)) / sum(Exp(:,indice_coal)) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Export|Market Share|Fossil fuels|Gas'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,indice_gas)) / sum(Exp(:,indice_gas)) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Export|Market Share|Fossil fuels|Oil'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,indice_oil))  / sum(Exp(:,indice_gas)) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Export|Market Share|Electricity'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Exp(k,indice_elec) / sum(Exp(:,indice_elec)) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Export|Market Share|Industries'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,indice_industries)) / sum(Exp(:,indice_industries)) * 100 ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Export|Market Share|Construction'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Exp(k,indice_construction) / sum(Exp(:,indice_construction)) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Export|Market Share|Services'; //   Mtoe or pseudo-quantities
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Exp(k,[transportIndexes indice_composite])) / sum(Exp(:,[transportIndexes indice_composite])) * 100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;
...
varname = 'Value Added|Agriculture|Share'; //   billion US$2014/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(VA(k,indice_agriculture))/1000/GDP_MER_nominal(k)*GDP_MER_real(k) / (sum(VA(k,:))/1000/GDP_MER_nominal(k)*GDP_MER_real(k))*100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Value Added|Fossil fuels|Share'; //   billion US$2014/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(VA(k,indice_coal:indice_Et))/1000/GDP_MER_nominal(k)*GDP_MER_real(k) / (sum(VA(k,:))/1000/GDP_MER_nominal(k)*GDP_MER_real(k))*100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Value Added|Electricity|Share'; //   billion US$2014/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(VA(k,indice_elec))/1000/GDP_MER_nominal(k)*GDP_MER_real(k)/ (sum(VA(k,:))/1000/GDP_MER_nominal(k)*GDP_MER_real(k))*100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Value Added|Industries|Share'; //   billion US$2014/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(VA(k,indice_industries))/1000/GDP_MER_nominal(k)*GDP_MER_real(k)/ (sum(VA(k,:))/1000/GDP_MER_nominal(k)*GDP_MER_real(k))*100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Value Added|Construction|Share'; //   billion US$2014/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(VA(k,indice_construction))/1000/GDP_MER_nominal(k)*GDP_MER_real(k)/ (sum(VA(k,:))/1000/GDP_MER_nominal(k)*GDP_MER_real(k))*100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;

varname = 'Value Added|Services|Share'; //   billion US$2014/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(VA(k,[transportIndexes indice_composite]))/1000/GDP_MER_nominal(k)*GDP_MER_real(k)/ (sum(VA(k,:))/1000/GDP_MER_nominal(k)*GDP_MER_real(k))*100;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;
