...
// Necessary Waysout output
varname = 'Output|Coal'; //   Mtoe
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,1);
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe";
end;

varname = 'Resource|Extraction|Coal'; //   EJ/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,indice_coal)* Mtoe_EJ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "EJ/yr";
end;

varname = 'Resource|Extraction|Oil'; //   EJ/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,indice_oil)* Mtoe_EJ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "EJ/yr";
end;

varname = 'Resource|Extraction|Gas'; //   EJ/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,indice_gas)* Mtoe_EJ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "EJ/yr";
end;

varname = 'Productivity|Coal'; //   -
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
...
varname = 'Output|Coal|Value'; //   -
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,1).*p(k,1)/GDP_MER_nominal(k)*GDP_MER_real(k)/1000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "-";
end;


varname = 'Employment|All'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Q(k,:).*l(k,:))/1000000;
...
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Q(k,1:4).*l(k,1:4))/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|Coal'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,1).*l(k,1)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|Oil'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,2).*l(k,2)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|Gas'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,3).*l(k,3)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|ET'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,4).*l(k,4)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|Elec'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,5).*l(k,5)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|BTP'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,6).*l(k,6)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|Services'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,7).*l(k,7)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|Air'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,8).*l(k,8)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|Mer'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,9).*l(k,9)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|Ot'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,10).*l(k,10)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|Agri'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,11).*l(k,11)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|Indus'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Q(k,12).*l(k,12)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;
...
varname = 'Ressource|Coal'; //   -
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = Ress_coal(k);
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe";
end;
...
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = L(k)*Z(k);
if current_time_im==yr_start & k==1; list_output_unit($+1) = "People";
end;

varname = 'Employment|ILO|Coal'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = labor_ILO(k,1)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|ILO|Oil'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = labor_ILO(k,2)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|ILO|Gas'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = labor_ILO(k,3)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|ILO|ET'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = labor_ILO(k,4)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|ILO|Elec'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = labor_ILO(k,5)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|ILO|BTP'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = labor_ILO(k,6)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|ILO|Services'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = labor_ILO(k,7)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|ILO|Air'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = labor_ILO(k,8)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|ILO|Mer'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = labor_ILO(k,9)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|ILO|Ot'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = labor_ILO(k,10)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|ILO|Agri'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = labor_ILO(k,11)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Employment|ILO|Indus'; //   Million full-time equivalent
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = labor_ILO(k,12)/1000000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Million full-time equivalent";
end;

varname = 'Labour|Force'; //   -
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = L(k);
if current_time_im==yr_start & k==1; list_output_unit($+1) = "People";
end;

// Additional coal energy balance

varname = 'Import|Coal'; //    EJ/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = -( energy_balance(imp_eb,coal_eb,k)) * Mtoe_EJ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "EJ/yr";
end;

varname = 'Export|Coal'; //    EJ/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = -( energy_balance(exp_eb,coal_eb,k)) * Mtoe_EJ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "EJ/yr";
end;

varname = 'Refineries|Coal'; //    EJ/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = energy_balance(refi_eb,coal_eb,k) * Mtoe_EJ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "EJ/yr";
end;


varname = 'Power Plants|Coal'; //    EJ/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = energy_balance(pwplant_eb,coal_eb,k) * Mtoe_EJ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "EJ/yr";
end;


varname = 'Losses|Coal'; //    EJ/yr
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = energy_balance(losses_eb,coal_eb,k) * Mtoe_EJ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "EJ/yr";
end;


// Additional coal variables

varname = 'K_expected|Coal'; //    
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = K_expected(k,coal);
if current_time_im==yr_start & k==1; list_output_unit($+1) = "Mtoe";
end;

varname = 'Charge|Coal'; //   
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = charge(k,coal);
if current_time_im==yr_start & k==1; list_output_unit($+1) = "-";
end;

varname = 'Price|World|Coal'; //   US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = wp(indice_coal)*usd_year1_year2/tep2gj;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/GJ";
end;
