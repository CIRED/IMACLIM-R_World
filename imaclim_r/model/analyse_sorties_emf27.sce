...
output_EMF27 = [ ["" '' string(2000+(1:TimeHorizon+1))]; output];
mkcsv("output_EMF27", CSVDIR);
...
pqOil = zeros(9,3);
for combi=30:38
    pqOil(combi-29,:) = [combi,sum(m_Qoilw(m_combi==combi,:))/7.33*365*mtoe2ej,m_wp_oil(m_combi==combi,100)*7.33/tep2gj];
    plot(pqOil(combi-29,2),pqOil(combi-29,3),"*","color",cmap(combi-29,:));
    legend(string(30:38));
end
