...
//on élimine les valeurs nulles parce que sinon ça ne calibre pas avec une fonction logit...
...
// K_cost_agriculture(pays,:)=(u.^2)';
// info
// test_logit_agr(K_cost_agriculture,[pArmCI_nexus(indice_coal,indice_agriculture,pays);5*pArmCI_nexus(indice_Et,indice_agriculture,pays);pArmCI_nexus(indice_gaz,indice_agriculture,pays);pArmCI_nexus(indice_elec,indice_agriculture,pays)],pays)
...
//disp('test logit composite')
// pays=7;
// Penergieutilecomposite(7,:)
// test_logit_ser(K_cost_composite,[pArmCI_nexus(indice_coal,indice_composite,pays);5*pArmCI_nexus(indice_Et,indice_composite,pays);pArmCI_nexus(indice_gaz,indice_composite,pays);pArmCI_nexus(indice_elec,indice_composite,pays)],pays)
