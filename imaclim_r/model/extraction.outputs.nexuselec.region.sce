...
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(delta_Cap_elec_MW_1(k,technoElecHydro))/10^3;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "GW";end
...
varname = 'SLCOE|Coal|wo/ CCS'; //  US$2010/MWh
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
j = find(techno_dispatch_type  == "CoalWOCCS");
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = LCC_8760_type_wo_IC(k,j) * usd_year1_year2 * 1e3;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/MWh";
end;

varname = 'SLCOE|Coal|w/ CCS'; //  US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
j = find(techno_dispatch_type  == "CoalWCCS");
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = LCC_8760_type_wo_IC(k,j) * usd_year1_year2* 1e3;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/MWh";
end;

varname = 'SLCOE|Gas|w/ CCS'; //  US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
j = find(techno_dispatch_type  == "GasWCCS");
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = LCC_8760_type_wo_IC(k,j) * usd_year1_year2 * 1e3;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/MWh";
end;

varname = 'SLCOE|Gas|CCGT'; //  US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
j = find(techno_dispatch_type  == "GasWCCS");
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = (LCC_8760(k,indice_GGC) - IC_elec_expand(k,indice_GGC)) * usd_year1_year2 * 1e3;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/MWh";
end;

varname = 'SLCOE|Gas|wo/ CCS'; //  US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
j = find(techno_dispatch_type  == "CoalWOCCS");
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = LCC_8760_type_wo_IC(k,j) * usd_year1_year2* 1e3 ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/MWh";
...
varname = 'SLCOE|Wind|Onshore'; //  US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = SLCC_ENR_1(k,1) * usd_year1_year2 * 1e3;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/MWh";
end;

varname = 'SLCOE|Wind|Offshore'; //  US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = SLCC_ENR_1(k,2) * usd_year1_year2 * 1e3;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/MWh";
end;

varname = 'SLCOE|Solar PV|Utility-scale'; //  US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = SLCC_ENR_1(k,3) * usd_year1_year2 * 1e3;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/MWh";
end;

varname = 'SLCOE|Solar PV|Buildings'; //  US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = SLCC_ENR_1(k,4) * usd_year1_year2 * 1e3;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/MWh";
end;

varname = 'LCOE|Wind|Onshore'; //  US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = LCC_ENR_1(k,1) * usd_year1_year2 * 1e3;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/MWh";
end;

varname = 'LCOE|Solar PV|Utility-scale'; //  US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = LCC_ENR_1(k,3) * usd_year1_year2 * 1e3;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/MWh";
end;


varname = 'Curtailment|Share'; //  %
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = curt_share(k) * 100 ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "% of electricity demand";
end;

varname = 'Curtailment|Volume'; //  US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = curt_share(k) * (energy_balance(pwplant_eb,elec_eb,k)*Mtoe_EJ) ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "US$2010/GJ";
end;

varname = 'Storage|Share'; //  US$2010/GJ
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = stor_share_1(k) * 100 ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "% of peak demand";
end;
...
varname = 'Electricity|Residual System CF'; //$/kW
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) =  res_sys_capa_factor(k) ;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "%";
end;
// Storage
varname = 'Capacity|Electricity|Storage'; // '  GW
counterLine =counterLine+ 1; if current_time_im==yr_start & k==1; list_output_str($+1) = varname; end;
outputs_temp(nbLines*(k-1)+counterLine,current_time_im+1) = sum(Cap_elec_MW(k,indice_STR))/1000;
if current_time_im==yr_start & k==1; list_output_unit($+1) = "GW";end;
