...
if ind_NLU > 0
    ...
    + outputs_temp(nbLines*[0:11] + line_BIGCC,ind_time) ./ sum(rho_elec_nexus(:,technoBiomassWOCCS).*msh_elec_techno(:,technoBiomassWOCCS),"c")./sum(msh_elec_techno(:,technoBiomassWOCCS),"c");
