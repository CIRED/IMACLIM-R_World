...
colour_industries <- c("#A6CEE3", "#1F78B4", "#01665E", "#33A02C", "#FB9A99", "#E31A1C", "#FDBF6F", "#FF7F00", "#191970", "#6A3D9A", "#FFD700","#A6CEE3", "#1F78B4", "#01665E", "#33A02C", "#FB9A99", "#E31A1C", "#FDBF6F", "#FF7F00", "#191970", "#6A3D9A", "#FFD700"
                       ,"#A6CEE3", "#1F78B4", "#01665E", "#33A02C", "#FB9A99", "#E31A1C", "#FDBF6F", "#FF7F00", "#191970")
...
#lies$ind$coord[,"Dim.1"]          <- - lies$ind$coord[,"Dim.1"]
#lies$ind$coord.partiel[,"Dim.1"]  <- - lies$ind$coord.partiel[,"Dim.1"]
#lies$global.pca$ind$coord[,"Dim.1"]    <- - lies$global.pca$ind$coord[,"Dim.1"]
##lies$group$coord[,"Dim.1"]        <- - lies$group$coord[,"Dim.1"]  

#lies.perm2$ind$coord[,"Dim.2"]          <- - lies.perm2$ind$coord[,"Dim.2"]
#lies.perm2$ind$coord.partiel[,"Dim.2"]  <- - lies.perm2$ind$coord.partiel[,"Dim.2"]
#lies.perm2$global.pca$ind$coord[,"Dim.2"]    <- - lies.perm2$global.pca$ind$coord[,"Dim.2"]
...
folder <- paste0(MFA,"/plots_Prod-Ind-Joint-30x5-share")
cat("Results will be located in",folder,"\n\n")
dir.create(folder, recursive = TRUE)
setwd(folder)


plotMFACT.Ind.joint(lies30.IndProd, lies30.ProdInd,"USA-1970-2007", 1, 2, quality = 10)
plotMFACT.Ind.joint(lies30.IndProd, lies30.ProdInd,"USA-1970-2007", 2, 3, quality = 50)
plotMFACT.Ind.joint(lies30.IndProd, lies30.ProdInd,"USA-1970-2007", 3, 4, quality = 10)
#plotMFACT.Ind.joint(lies30.IndProd, lies30.ProdInd,"USA-1970-2007", 4, 5, quality = 10)
