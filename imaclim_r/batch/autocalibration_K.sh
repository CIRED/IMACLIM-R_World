...
for i in 11
do
    echo "real_TimeHorizon=15;covid_crises_shock=%f;autocalib_K=%t;combi=$i;isBatch = %t;deff('clf(varargin)','');deff('plot(varargin)','');exec('imaclimr.sce');exit;"  > run.cmdFile$i.sce
