...
// Licence: AGPL-3.0
// Authors:
//     Ruben Bibas, Florian Leblanc, Adrien Vogt-Schilb
...
computeBiomassCost(supplyCurve,prodBiomass,rho_elec_nexus,emissions,emissionsCCS,croyance_taxe,taxCO2_CI_biomass,exogenousMaxQ,isReal,priceCap)
    ...
    costBIGCC_noTax    = (resourcePrice /(gj2tep/1e6))*dollar2MDollar * ones(croyance_taxe);
    costBIGCCS_noTax   = (resourcePrice /(gj2tep/1e6))*dollar2MDollar * ones(croyance_taxe);
